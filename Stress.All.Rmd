...
summary(smod) #adjusted r squared = 0.233
Anova(smod, type=2)
AIC(smod);BIC(smod)
par(mfrow=c(2,2))
plot(smod)
...
Creating the distance matrix dataframe
```{r}
...
,3:5,6:8,9:13,14:16,17:20,21:24,25:26,27:30,31:32,33:36,38:40,41:42,43:46,47:48,49:53,54:55])
