...
```{r}
library(ecodist)
MRM1 <-MRM(Y2d.stress ~ ngpop2 + euclid.clim.subset + km.subset.d, nperm=1000, method="linear", mrank=FALSE)
MRM(Y2d.stress ~ ngpop2, nperm=1000, method="linear", mrank=FALSE)
MRM(Y2d.stress ~ euclid.clim.subset, nperm=1000, method="linear", mrank=FALSE)
MRM(Y2d.stress ~ km.subset.d, nperm=1000, method="linear", mrank=FALSE)
MRM1
AIC(MRM1)
MRM(Ion.dist ~ ngpop2 + euclid.clim.subset + km.subset.d, nperm=1000, method="linear", mrank=FALSE)
```
